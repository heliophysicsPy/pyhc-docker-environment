...
# (forcibly install boto3 & botocore v1.39.9 to avoid botocore conflict between pySPEDAS/cloudcatalog/pyRFU/SWxSOC from March 6/July 3/Aug 15, 2025)
PIP_INSTALL_OUTPUT_s3transfer=$(pip install s3transfer==0.13.0)
PIP_INSTALL_OUTPUT_boto3=$(pip install boto3==1.39.9)
PIP_INSTALL_OUTPUT_botocore=$(pip install botocore==1.39.9)
