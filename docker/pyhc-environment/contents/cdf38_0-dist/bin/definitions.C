...
setenv CDF_BASE /work/dependencies/cdf38_0-dist
...
if $?LD_LIBRARY_PATH then
  set LDY=`printenv LD_LIBRARY_PATH`
  if ( $LDY !~ \*$CDF_BASE/lib\* ) then
    setenv LD_LIBRARY_PATH $CDF_BASE/lib:$LD_LIBRARY_PATH
  endif
else
  setenv LD_LIBRARY_PATH $CDF_BASE/lib
endif
